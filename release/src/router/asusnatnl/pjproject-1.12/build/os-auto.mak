...
export OS_LDFLAGS  := -L/home/paldier/asuswrt/release/src-lantiq/router/openssl    -L/home/paldier/asuswrt/release/src-lantiq/tools/toolchain-mips_mips32_gcc-4.8-linaro_uClibc-0.9.33.2/lib  -ldl -lc -lgcc_s -lm -lnsl -lrt -lpthread  -lssl -lcrypto    -lstdc++ -lcrypto -lssl
