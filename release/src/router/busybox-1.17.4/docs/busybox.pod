...
Currently available applets include:
	...
	dmesg, du, e2fsck, echo, egrep, env, ether-wake, expr, fdisk, fgrep,
	find, flock, free, fsck, fsck.ext2, fsck.ext3, fsck.minix, fsync,
	grep, gunzip, gzip, head, ifconfig, insmod, ionice, kill, killall,
	klogd, less, ln, logger, login, ls, lsmod, lspci, lsusb, md5sum,
	mdev, mkdir, mke2fs, mkfs.ext2, mkfs.ext3, mknod, mkswap, modprobe,
	more, mount, mv, netstat, nice, nohup, nslookup, pidof, ping, ping6,
	printf, ps, pwd, readlink, renice, rm, rmdir, rmmod, route, sed,
	setconsole, sh, sleep, sort, start-stop-daemon, strings, swapoff,
	swapon, sync, syslogd, tail, tar, telnetd, test, tftp, top, touch,
	tr, traceroute, traceroute6, true, tune2fs, udhcpc, umount, uname,
	uniq, unzip, uptime, usleep, vconfig, vi, watch, wc, which, xargs,
	zcat, zcip
