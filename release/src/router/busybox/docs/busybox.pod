...
Currently available applets include:
	...
	mdev, mkdir, mknod, mkswap, modprobe, more, mount, mv, netstat,
	nice, nohup, nslookup, pidof, ping, ping6, printf, ps, pwd,
	readlink, renice, rm, rmdir, rmmod, route, sed, setconsole, sh,
	shuf, sleep, sort, start-stop-daemon, strings, swapoff, swapon,
	sync, syslogd, tail, tar, telnetd, test, tftp, top, touch, tr,
	traceroute, traceroute6, true, udhcpc, umount, uname, uniq, unzip,
	uptime, usleep, vconfig, vi, watch, wc, which, xargs, zcat, zcip
