...
#define errno_to_idx(code) (0 ? -1 \
  ...
  : ((code >= 11) && (code <= 46)) ? (code - 0) \
  : ((code >= 50) && (code <= 56)) ? (code - 3) \
  : ((code >= 59) && (code <= 71)) ? (code - 5) \
  : ((code >= 73) && (code <= 74)) ? (code - 6) \
  : ((code >= 77) && (code <= 99)) ? (code - 8) \
  : ((code >= 120) && (code <= 122)) ? (code - 28) \
  : ((code >= 122) && (code <= 135)) ? (code - 27) \
  : ((code >= 137) && (code <= 140)) ? (code - 28) \
  : ((code >= 143) && (code <= 151)) ? (code - 30) \
  : ((code >= 158) && (code <= 160)) ? (code - 36) \
  : ((code >= 1133) && (code <= 1133)) ? (code - 1008) \
  : -1)
